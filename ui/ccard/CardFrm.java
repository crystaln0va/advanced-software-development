...
public class CardFrm extends javax.swing.JFrame {
    ...
    public CardFrm() {
        thisframe = this;
        service = new AccountServiceImpl(new CreditCardFactory());
...
//        rowdata = new Object[8];
    ...
    void JButtonNewCCAC_actionPerformed(java.awt.event.ActionEvent event) {
		...
		*/
        ...
        if (newaccount) {
            ...
            Client creditCardClient = new CreditCardClient(clientName, address, email, expdate);
    ...
    void JButtonGenerateBill_actionPerformed(java.awt.event.ActionEvent event) {
     //   System.out.println("report"+service.getReport());
        JDialogGenBill billFrm = new JDialogGenBill(service.getReport());
